      ...
      <View className="p-4">
        <View className="flex-row gap-3 mb-6">
          <View className="flex-1">
            <TouchableOpacity
              className="w-full h-20 bg-primary rounded-lg justify-center"
          ...
          <View className="flex-1">
            <TouchableOpacity className="w-full h-20 bg-card rounded-lg border border-border justify-center">
              <View className="items-center">
      ...
      <Modal visible={showFoodTracker} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView className="flex-1 bg-background">
          <View className="flex-row items-center justify-between p-4 border-b border-border">
            <H3>Food Tracker</H3>
            <TouchableOpacity onPress={() => setShowFoodTracker(false)}>
